...
(function () {
  ...
  var PHOTOS = [
    ...
    { file: 'gal-level-survey', w: 1200, h: 1600, alt: 'A survey level on a tripod with a team member recording behind it', cap: 'Surveying a cross-section' },
    { file: 'gal-clipboard', w: 1200, h: 1600, alt: 'A clipboard of field measurements held above the creek', cap: 'Logging measurements' },
